<?php /* Smarty version 2.6.30, created on 2018-03-16 16:29:58
         compiled from CRM%5CAdmin%5CForm%5CPreferences%5CDisplay.tpl */ ?>
...
-contactedit" class="ui-state-default ui-corner-all"
 ...
 <?php echo $this->_tpl_vars['form']['preserve_activity_tab_filter']['label']; ?>
</td>
    </tr>
    <tr class="crm-preferences-display-form-block-description">
      <td>&nbsp;</td>
      <td class="description"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>When enabled, any filter settings a user selects on the contact's Activity tab will be remembered as they visit other contacts.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
      </td>
    </tr>
